...
public class UIS {
	...
	public static void main(String[] args) {
		...
		System.out.println( "El siguiente valor es el Salario del Empleado despues de realizar los respectivos descuentos de salud y pensión: " + NuevoEmpleado.DevolverSalario(NuevoEmpleado) + ". ");
		
		System.out.println ("El Empleador (UIS) se encarga de girar los siguientes valores a las entidades de Salud, Pensión, Sena e ICBF de acuerdo al salirio del Empleado ");
		
		System.out.println( "Salud: "+ (NuevoEmpleado.getSalario()*0.085));
		System.out.println( "Pensión: "+ (NuevoEmpleado.getSalario()*0.16));
		System.out.println( "SENA: "+ (NuevoEmpleado.getSalario()*0.02));
		System.out.println( "ICBF: "+ (NuevoEmpleado.getSalario()*0.03));
		System.out.println( "Caja de Compensación: "+ (NuevoEmpleado.getSalario()*0.04));
	}
